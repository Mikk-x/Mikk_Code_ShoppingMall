package mikk.com.mikk_code_shappingmall.cart.adapter;
...
import mikk.com.mikk_code_shappingmall.cart.view.AddSubView;
...
public class CartRecyclerViewAdapter extends RecyclerView.Adapter<CartRecyclerViewAdapter.ViewHolder> {
    ...
    public CartRecyclerViewAdapter
            (Context mContext, List<GoodsBean> list, TextView tvShopcartTotal, CheckBox checkboxAll, CheckBox cbAll) {
            ...
            for (int i = 0; i < datas.size(); i++) {
                ...
                if (goodsBean.isSelected()) {
                    totalPrice = totalPrice +
                            Double.valueOf(goodsBean.getNumber()) * Double.valueOf(goodsBean.getCover_price());
                }
            }
        }
        return totalPrice;
